...
## Files
* (updi_programmer.brd)[Eagle Board file]
* (updi_programmer.sch)[Eagle Schematics file]
* (updi_programmer_components.jpg)[Components]
* (updi_programmer_outline.png)[Interior]
* (updi_programmer_traces.png)[Traces]
* (updi_programmer_calib.png)[Calibration]
## Milling
...
When calculating the toolpaths with (http://mods.cba.mit.edu/)[mods] We used 0.23 mm as the tool width for traces and calibration and 1 mm for the outline.
